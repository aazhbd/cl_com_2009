...
<div style="width:735px;">   
    ...
    <form id="frmblog" name="frmblog" method="post" action="{$smarty.const.URL}/saveblog.php">
        <fieldset>
            <legend>Enter a name for your blog and create an url/address to access your blog</legend>
                <div>
                    <span>
                        ...
                        <input type="text" name="blogname" id="blogname" size="20" value="{$blog.cname}" />
                ...
                <div>
                    <span>
                        ...
                        http://conveylive.com/b/<input type="text" name="blogurl" id="blogurl" size="15" value="{$blog.url}"  />&nbsp;<strong><a href="#" id="checkavail" >Check Availability</a></strong>
                ...
                <div>
                    <span align="left">
                        ...
                        <input type="hidden" name="permission" id="permission" size="30" value="{$blog.permission}"/>
                        <input type="hidden" name="cdate" id="cdate" size="30" value="{$blog.cdate}"/>
                        <input type="hidden" name="blogid" id="blogid" size="30" value="{$blog.id}"/>
                        <input type="hidden" name="action" id="action" size="30" value="{$action}"/>
                    </span>
                </div>
        </fieldset>
    </form>
