...
<div style="width:735px;">
    ...
    {/if}
    <p class="subtitle">Conveylive.com ensures your privacy; to know more, check our <a href="{$smarty.const.URL}/static/privacy">Privacy Policy</a>.</p>
        ...
        <fieldset title="Signup form">
            ...
            <div>
                <span class="ad" align="left">
                    ...
                    I agree with the <a href='{$smarty.const.URL}/static/privacy'>Privacy Policy</a> and <a href='{$smarty.const.URL}/static/terms'>Terms and Conditions</a>
                    </label><br/>
                </span>
            </div>
            <div>
