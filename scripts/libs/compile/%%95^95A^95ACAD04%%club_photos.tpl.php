<?php /* Smarty version 2.6.26, created on 2010-01-26 16:16:19
         compiled from club_photos.tpl */ ?>
<?php echo '
...
/saveclubphoto.php" id="frmclubphoto" enctype="multipart/form-data" >
<fieldset>
...
"/>
        ...
        <div>
            <span>
                <div><input name="submit" type="submit" value="Add Photos" class="frmbtn" />&nbsp;   <a href="<?php echo @URL; ?>
/clubs/view/<?php echo $this->_tpl_vars['club_id']; ?>
">Cancel</a></div>
            </span>
        </div>
